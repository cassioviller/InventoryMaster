      ...
      {selectedCostCenter && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {totals.entryCount} movimentações
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className={`text-2xl font-bold ${totals.totalEntries - totals.totalExits >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {formatCurrency(totals.totalEntries - totals.totalExits)}
              </div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {totals.entryCount + totals.exitCount} movimentações
              </p>
            </CardContent>
          </Card>
        </div>
